...
public class GameCourt extends JPanel {
	...
	private static final String DEFAULT_PATH = 
			"/Users/jeffreyxiao/Desktop/CIS120/Minesweeper/files";
	private static String path = "/Users/jeffreyxiao/CIS120/Minesweeper";
	 ...
	 * To me, a message dialog is more satisfying and attention-grabbing than a label
	 */
	public void makeInstructionsPane() {

		String instructions = "Welcome to Minesweeper!\n\nMinesweeper is one of the earliest puzzle"
				+ " games created. Still, it's legacy is timeless, and here you are - ready to play"
				+ "! Keep reading if you are not familiar with how to play.\n\nIn this version, you"
				+ " are given a 16 x 16 size grid, each with a total of 30 bombs distributed "
				+ "randomly. Your goal is to click ALL of the cells that aren't bomb-triggered.\nIf"
				+ " you manage to do so, great job! You've won! Otherwise, it's game over for you."
				+ "\n\nHere comes the fun part. Clicking on a cell (if not a bomb) reveals one or "
				+ "more cells, each with a number. The number of each cell tells you how many bombs"
				+ " are in its neighboring vicinity.\n\n"
				+ "One more thing: right-click on a square to flag a cell. Right-click it again to "
				+ "unflag it. Flagging a cell is essentially just a tool for you to use so that you"
				+ " can keep track of which cells may be bombs.\nBut be cautious while flagging! "
				+ "Flagged cells won't automatically be reveal even if it does not contain a bomb."
				+ "\n\n"
				...
				+ "a cell. Right-click to flag a cell.\n\n\nThis game was created by Jeffrey Xiao "
				+ "as a project for CIS120.";
	 ...
	 * Note: will not be able to undo previously made moves in an imported game
	 * Note: implementation of undo may be a bit flawed if user uncovers all non-zero
	 * 	cells surrounding the 0 first. Undo here would then uncover the previously non-zero cells,
